...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 1535800, PLL_2, 3, 0, UINT_MAX, 1150, VDD_RAW(1150), &pll2_tbl[6]},
	{ 1, 1631800, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1200), &pll2_tbl[7]},
	{ 1, 1727800, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1250), &pll2_tbl[8]},
	{ 1, 1823800, PLL_2, 3, 0, UINT_MAX, 1325, VDD_RAW(1325), &pll2_tbl[9]},
#endif
	{ 0 }
};
#else
...
#ifdef CONFIG_MSM_CPU_FREQ_OVERCLOCKING
	{ 1, 1535800, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1250), &pll2_tbl[6]},
	{ 1, 1631800, PLL_2, 3, 0, UINT_MAX, 1275, VDD_RAW(1275), &pll2_tbl[7]},
	{ 1, 1727800, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1300), &pll2_tbl[8]},
	{ 1, 1823800, PLL_2, 3, 0, UINT_MAX, 1325, VDD_RAW(1325), &pll2_tbl[9]},
#endif
	{ 0 }
};
